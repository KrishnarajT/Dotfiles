...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "v", function () awful.util.spawn_with_shell("scrot 'screenshot_%Y-%m-%d_at_%H%M%S.png' -e 'mv $f ~/Pictures/Screenshots/'") end,
  	  		  {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey,           }, "]", function () awful.spawn("brave-browser") end,
              {description = "open brave", group = "launcher"}),
    awful.key({ modkey,           }, "'", function () awful.util.spawn_with_shell("feh --bg-scale --randomize ~/Pictures/Wallpapers/Minimilist/*") end,
...
-- awful.util.spawn('gnome-system-manager')
...
awful.util.spawn_with_shell("feh --bg-scale --randomize ~/Pictures/Wallpapers/Minimilist/*")
