...
-- volumebar widget
-- local volumebar_widget = require("awesome-wm-widgets.volumebar-widget.volumebar.lua")
...
do
    ...
    awesome.connect_signal("debug::error", function (err)
        ...
        naughty.notify({ preset = naughty.config.presets.critical,
                         title = "Oops, bruhh ! an error happened!",
                         text = tostring(err) })
        in_error = false
    end)
end
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,           }, "v", function () awful.util.spawn_with_shell("screenshot.sh") end,
  	  		  {description = "open a terminal", group = "launcher"}),
    awful.key({ modkey,           }, "]", function () awful.spawn("brave-browser") end,
              {description = "open a browser", group = "launcher"}),
    awful.key({ modkey,           }, "'", function () awful.util.spawn_with_shell("feh --bg-scale --randomize ~/Pictures/Wallpapers/Quotefancy/*") end,
    ...
    awful.key({ modkey },            "space",     function () awful.spawn.with_shell("rofi -modi drun -show drun") end, {description = "run prompt", group = "launcher"}),
    awful.key({ modkey }, "x",
              function ()
                  awful.prompt.run {
                    prompt       = "Run Lua code: ",
...
do
  ...
  {
    "compton",
    "feh --bg-scale --randomize ~/Pictures/Wallpapers/Quotefancy/*",
  }

awful.util.spawn_with_shell("feh --bg-scale --randomize ~/Pictures/Wallpapers/Quotefancy/*")
awful.util.spawn_with_shell("firefox")
awful.util.spawn_with_shell("nautilus")
awful.util.spawn_with_shell("brave-browser")
awful.util.spawn_with_shell("Sayonara-Player")
awful.util.spawn_with_shell("rambox")
awful.util.spawn_with_shell("blueman-manager")
awful.spawn("sayonara-player")
awful.spawn("Up-Clock")
...
-- Add the useless gaps between the clients

beautiful.useless_gap = 5

-- Add the volume up and down shortcut via the terminal, i dont know how to sort out the sudo privilidges thing yet

-- awful.key({ }, "#122", function () awful.util.spawn("amixer -D pulse sset Master 5%-") end)


-- Make the clients and basically all the windows rounded
